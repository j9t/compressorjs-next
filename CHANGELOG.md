...
* Bumped version to provide release with up-to-date dependencies
...
* Replaced manual browser global declarations in ESLint config with `globals.browser` from the `globals` package
